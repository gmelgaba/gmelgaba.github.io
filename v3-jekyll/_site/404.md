  ...
  <div class="section">
    ...
    <div class="row">
      <div class="col-sm-6">
        ...
        <p class="flow-text">I did my degree at the University of the Republic, and I have 10+ years of experience as a developer, learning while I work with great people.</p>
        ...
        <div class="col col-4 col-d-4 col-t-4 col-m-12  smooth-border-v ">
          <div class="box-item">
            ...
            <div class="desc">
              ...
              <div class="text">
                <p>I've been jumping a lot between editors and for me, VS Code is the best choise out there. It's a great editor with a great community and tons of usefull extensions to add.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col col-4 col-d-4 col-t-4 col-m-12  smooth-border-v ">
          <div class="box-item">
            ...
            <div class="desc">
              ...
              <div class="text">
                <p>This is by far the best terminal option out there. Warp is a fully native, GPU-accelerated, Rust-based terminal, it's currently in beta and onnly has support for Mac, but you should try it if able.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col col-4 col-d-4 col-t-4 col-m-12  smooth-border-v ">
          <div class="box-item">
            ...
            <div class="desc">
              ...
              <div class="text">
                <p>Free, open source, graphical database management tool for database. Easy to use and super helpful in times of need.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="box-item">
            <div class="image">
              <a target="_blank" href="https://insomnia.rest/">
                <img class="image" src="/assets/images/tools/insomnia.png">
              </a>
            </div>
            <div class="desc">
              <a class="name" target="_blank" href="https://insomnia.rest/" >Insomnia</a>
              <div class="text">
                <p>Free Cross-Platform Desktop Framework for building and using APIs. For graphql APIs in particular this one takes the first place.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="box-item">
        <div class="image">
          <a target="_blank" href="https://open.spotify.com/playlist/7pNGWvGYEZB47iNsMF0G86?si=b9030434e65645d7">
            <img class="image" src="/assets/images/playlists/last-of-us.jpg">
          </a>
        </div>
        <div class="desc">
      ...
      <div class="box-item">
        <div class="image">
          <a target="_blank" href="https://open.spotify.com/playlist/2jnf3EgFNH2hX6L2ekTxGH">
            <img class="image" src="/assets/images/playlists/crying-eyes.jpg">
          </a>
        </div>
        <div class="desc">
